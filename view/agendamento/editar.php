...
<body>
    ...
    echo "<form action='../../index.php?" . "id=$id_agendamento " . "&classe=Agendamento&metodo=update'" . ' method="POST">';

    echo '<label for="Inome">Id do cliente:</label><br>';
    echo '<input name="id_cliente" type="number"' . "value=$cliente_id " . 'id="Icliente"><br><br>';

    echo '<label for="Iserv">Id do servico:</label><br>';
    echo '<input name="id_servico" type="number"' . "value=$servico_id " . 'id="Iserv"><br><br>';
    ...
    echo '<label for="Iduracao">Duração:</label><br>';
    echo '<input name="duracao" type="number"' . "value=$duracao " . 'id="Iduracao"><br><br>';

    echo '<label for="Istatus">Status:</label><br>';
    echo '<input name="status" type="text"' . "value=$status " . 'id="Istatus"><br><br>';
