...
<body>
    ...
    echo "<form action='../../index.php?" . "id=$id_produto " . "&classe=Produto&metodo=update'" . ' method="POST">';
    ...
    echo '<input name="valor" type="number"' . "value=$valor " . 'id="Ivalor"><br><br>';

    echo '<label for="Imarca">Marca:</label><br>';
    echo '<input name="marca" type="text"' . "value=$marca " . 'id="Imarca"><br><br>';

    echo '<label for="Icat">Categoria:</label><br>';
    echo '<input name="categoria" type="text"' . "value=$categoria " . 'id="Icat"><br><br>';
